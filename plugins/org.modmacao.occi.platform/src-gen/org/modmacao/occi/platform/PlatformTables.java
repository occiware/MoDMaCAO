 ...
 * from:
 *   /org.modmacao.occi.platform/model/platform.ecore
 * using:
 *   /org.modmacao.occi.platform/model/platform.genmodel
...
public class PlatformTables
{
	...
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_App_tpl = org.modmacao.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore.getClassId("App_tpl", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Application = org.modmacao.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore.getClassId("Application", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Class = org.modmacao.occi.platform.PlatformTables.PACKid_$metamodel$.getClassId("Class", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Component = org.modmacao.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore.getClassId("Component", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Componentlink = org.modmacao.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore.getClassId("Componentlink", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Database = org.modmacao.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore.getClassId("Database", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Databaselink = org.modmacao.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore.getClassId("Databaselink", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Entity = org.modmacao.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_ogf_org_s_occi_s_core_s_ecore.getClassId("Entity", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Res_tpl = org.modmacao.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore.getClassId("Res_tpl", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Resource = org.modmacao.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_ogf_org_s_occi_s_core_s_ecore.getClassId("Resource", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.DataTypeId DATAid_URI = org.modmacao.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore.getDataTypeId("URI", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.DataTypeId DATAid_URL = org.modmacao.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore.getDataTypeId("URL", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.EnumerationId ENUMid_Status = org.modmacao.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore.getEnumerationId("Status");
	...
	public static final /*@NonInvalid*/ java.lang.String STR_Componentlink_c_c_targetConstraint = "Componentlink::targetConstraint";
	...
	public static class Operations {
		...
		public static final /*@NonNull*/ ExecutorOperation _Application__configure = new ExecutorOperation("configure", TypeUtil.EMPTY_PARAMETER_TYPES, Types._Application,
			0, TemplateParameters.EMPTY_LIST, null);
		public static final /*@NonNull*/ ExecutorOperation _Application__deploy = new ExecutorOperation("deploy", TypeUtil.EMPTY_PARAMETER_TYPES, Types._Application,
		...
		public static final /*@NonNull*/ ExecutorOperation _Application__undeploy = new ExecutorOperation("undeploy", TypeUtil.EMPTY_PARAMETER_TYPES, Types._Application,
			4, TemplateParameters.EMPTY_LIST, null);

		public static final /*@NonNull*/ ExecutorOperation _Component__configure = new ExecutorOperation("configure", TypeUtil.EMPTY_PARAMETER_TYPES, Types._Component,
			0, TemplateParameters.EMPTY_LIST, null);
		public static final /*@NonNull*/ ExecutorOperation _Component__deploy = new ExecutorOperation("deploy", TypeUtil.EMPTY_PARAMETER_TYPES, Types._Component,
			1, TemplateParameters.EMPTY_LIST, null);
		...
		public static final /*@NonNull*/ ExecutorOperation _Component__stop = new ExecutorOperation("stop", TypeUtil.EMPTY_PARAMETER_TYPES, Types._Component,
			3, TemplateParameters.EMPTY_LIST, null);
		public static final /*@NonNull*/ ExecutorOperation _Component__undeploy = new ExecutorOperation("undeploy", TypeUtil.EMPTY_PARAMETER_TYPES, Types._Component,
			4, TemplateParameters.EMPTY_LIST, null);
	...
	public static class FragmentOperations {
		...
		private static final /*@NonNull*/ ExecutorOperation /*@NonNull*/ [] _Application__Application = {
			PlatformTables.Operations._Application__configure /* configure() */,
			PlatformTables.Operations._Application__deploy /* deploy() */,
			PlatformTables.Operations._Application__start /* start() */,
			PlatformTables.Operations._Application__stop /* stop() */,
			PlatformTables.Operations._Application__undeploy /* undeploy() */
		};
	...
	public static class EnumerationLiterals {
		...
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _Status__undeployed = new EcoreExecutorEnumerationLiteral(PlatformPackage.Literals.STATUS.getEEnumLiteral("undeployed"), Types._Status, 0);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _Status__deployed = new EcoreExecutorEnumerationLiteral(PlatformPackage.Literals.STATUS.getEEnumLiteral("deployed"), Types._Status, 1);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _Status__active = new EcoreExecutorEnumerationLiteral(PlatformPackage.Literals.STATUS.getEEnumLiteral("active"), Types._Status, 2);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _Status__inactive = new EcoreExecutorEnumerationLiteral(PlatformPackage.Literals.STATUS.getEEnumLiteral("inactive"), Types._Status, 3);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _Status__error = new EcoreExecutorEnumerationLiteral(PlatformPackage.Literals.STATUS.getEEnumLiteral("error"), Types._Status, 4);
