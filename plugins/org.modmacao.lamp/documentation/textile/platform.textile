...
Enhanced OCCI Platform Extension, version 1.2.
...
| deploy | http://schemas.modmacao.org/occi/platform/application/action# |  |  |
| undeploy | http://schemas.modmacao.org/occi/platform/application/action# |  |  |
| configure | http://schemas.modmacao.org/occi/platform/application/action# |  |  |
| start | http://schemas.modmacao.org/occi/platform/application/action# |  | Start the application. |
| stop | http://schemas.modmacao.org/occi/platform/application/action# |  | Stop the application. |
...
| *Term* | *Scheme* | *Attributes* | *Title* |
| deploy | http://schemas.modmacao.org/occi/platform/component/action# |  |  |
| undeploy | http://schemas.modmacao.org/occi/platform/component/action# |  |  |
| configure | http://schemas.modmacao.org/occi/platform/component/action# |  |  |
| start | http://schemas.modmacao.org/occi/platform/component/action# |  | Start the application. |
| stop | http://schemas.modmacao.org/occi/platform/component/action# |  | Stop the application. |
...
Generated at Mon Jul 23 13:45:33 CEST 2018 from http://schemas.modmacao.org/occi/platform by org.eclipse.cmf.occi.core.gen.textile
