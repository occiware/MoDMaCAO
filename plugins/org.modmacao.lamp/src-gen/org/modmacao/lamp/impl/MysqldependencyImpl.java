...
public class MysqldependencyImpl extends ExecutiondependencyImpl implements Mysqldependency {
	...
	public boolean TargetMustBeMySQL(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, LampTables.STR_Mysqldependency_c_c_TargetMustBeMySQL);
		...
		if (le) {
			...
			try {
				final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_occi_c_c_Link_0 = idResolver.getClass(LampTables.CLSSid_Link, null);
				...
				while (true) {
					 ...
					 * m.oclIsTypeOf(Mysql)
					 */
					final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_lamp_c_c_Mysql_0 = idResolver.getClass(LampTables.CLSSid_Mysql, null);
					final /*@NonInvalid*/ boolean oclIsTypeOf = OclAnyOclIsTypeOfOperation.INSTANCE.evaluate(executor, m, TYP_lamp_c_c_Mysql_0).booleanValue();
					//
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, LampTables.STR_Mysqldependency_c_c_TargetMustBeMySQL, this, (Object)null, diagnostics, context, (Object)null, severity_0, CAUGHT_result, LampTables.INT_0).booleanValue();
