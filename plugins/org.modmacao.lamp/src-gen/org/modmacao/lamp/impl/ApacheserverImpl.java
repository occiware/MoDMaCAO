...
public class ApacheserverImpl extends ComponentImpl implements Apacheserver {
	...
	public boolean OneOrMoreTomcatDependencies(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		 ...
		 *   let
		 *     severity : Integer[1] = 'Apacheserver::OneOrMoreTomcatDependencies'.getSeverity()
		 *   in
		 *     if severity <= 0
		 *     then true
		 *     else
		 ...
		 *         ->collect(l | l.parts)
		 *         ->select(mb | mb.oclIsTypeOf(Tomcatdependency))
		 *         ->size() >= 1
		 *       in
		 *         'Apacheserver::OneOrMoreTomcatDependencies'.logDiagnostic(self, null, diagnostics, context, null, severity, result, 0)
		 *     endif
		 */
		final /*@NonInvalid*/ Executor executor = PivotUtilInternal.getExecutor(this);
		final /*@NonInvalid*/ IdResolver idResolver = executor.getIdResolver();
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, LampTables.STR_Apacheserver_c_c_OneOrMoreTomcatDependencies);
		...
		if (le) {
			...
			try {
				...
				while (true) {
					 ...
					 * l.oclIsTypeOf(platform::Componentlink)
					 */
					final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_platform_c_c_Componentlink = idResolver.getClass(LampTables.CLSSid_Componentlink, null);
				...
				while (true) {
					...
					/**
					 * mb.oclIsTypeOf(Tomcatdependency)
					 */
					final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_lamp_c_c_Tomcatdependency = idResolver.getClass(LampTables.CLSSid_Tomcatdependency, null);
					final /*@NonInvalid*/ boolean oclIsTypeOf_0 = OclAnyOclIsTypeOfOperation.INSTANCE.evaluate(executor, mb, TYP_lamp_c_c_Tomcatdependency).booleanValue();
					//
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, LampTables.STR_Apacheserver_c_c_OneOrMoreTomcatDependencies, this, (Object)null, diagnostics, context, (Object)null, severity_0, CAUGHT_result, LampTables.INT_0).booleanValue();
