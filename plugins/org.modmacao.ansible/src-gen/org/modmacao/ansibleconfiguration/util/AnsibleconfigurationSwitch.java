...
public class AnsibleconfigurationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AnsibleconfigurationPackage.ANSIBLEENDPOINT: {
				Ansibleendpoint ansibleendpoint = (Ansibleendpoint)theEObject;
				T result = caseAnsibleendpoint(ansibleendpoint);
				if (result == null) result = caseIpnetworkinterface(ansibleendpoint);
				if (result == null) result = caseMixinBase(ansibleendpoint);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Ansibleendpoint</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Ansibleendpoint</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAnsibleendpoint(Ansibleendpoint object) {
		return null;
	}
