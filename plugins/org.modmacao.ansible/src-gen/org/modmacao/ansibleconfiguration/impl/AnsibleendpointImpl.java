...
public class AnsibleendpointImpl extends MixinBaseImpl implements Ansibleendpoint {
	...
	public boolean appliesConstraint(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, AnsibleconfigurationTables.STR_Ansibleendpoint_c_c_appliesConstraint);
		final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, AnsibleconfigurationTables.INT_0).booleanValue();
		/*@NonInvalid*/ boolean symbol_0;
		if (le) {
			symbol_0 = ValueUtil.TRUE_VALUE;
		}
		else {
			final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_infrastructure_c_c_Networkinterface = idResolver.getClass(AnsibleconfigurationTables.CLSSid_Networkinterface, null);
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, AnsibleconfigurationTables.STR_Ansibleendpoint_c_c_appliesConstraint, this, (Object)null, diagnostics, context, (Object)null, severity_0, result, AnsibleconfigurationTables.INT_0).booleanValue();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case AnsibleconfigurationPackage.ANSIBLEENDPOINT___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP:
