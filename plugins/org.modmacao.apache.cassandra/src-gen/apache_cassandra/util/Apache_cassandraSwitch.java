 ...
 * @generated
 */
public class Apache_cassandraSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static Apache_cassandraPackage modelPackage;
	 ...
	 * @generated
	 */
	public Apache_cassandraSwitch() {
		if (modelPackage == null) {
			modelPackage = Apache_cassandraPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Apache_cassandraPackage.NODE: {
				...
				if (result == null) result = caseMixinBase(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Apache_cassandraPackage.SEED: {
				...
				if (result == null) result = caseNode(seed);
				if (result == null) result = caseComponent(seed);
				if (result == null) result = caseMixinBase(seed);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
