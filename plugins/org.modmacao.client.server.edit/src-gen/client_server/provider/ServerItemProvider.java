...
/**
 * This is the item provider adapter for a {@link client_server.Server} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServerItemProvider extends ComponentItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Server_serverPort_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Server_serverPort_feature", "_UI_Server_type"),
				 Client_serverPackage.Literals.SERVER__SERVER_PORT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Server)object).getModmacaoComponentVersion();
