 ...
 */
public class Ssh_keyConnector extends org.eclipse.cmf.occi.infrastructure.impl.Ssh_keyImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(Ssh_keyConnector.class);

	// Start of user code Ssh_keyconnector_constructor
	/**
	 * Constructs a ssh_key connector.
	 */
	Ssh_keyConnector()
	{
