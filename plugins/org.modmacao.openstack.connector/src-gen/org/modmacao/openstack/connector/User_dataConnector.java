 ...
 */
public class User_dataConnector extends org.eclipse.cmf.occi.infrastructure.impl.User_dataImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(User_dataConnector.class);

	// Start of user code User_dataconnector_constructor
	/**
	 * Constructs a user_data connector.
	 */
	User_dataConnector()
	{
