 ...
 * </p>
 * <ul>
 *   <li>{@link org.occiware.occi.platform.impl.ComponentImpl#getOcciComponentState <em>Occi Component State</em>}</li>
 *   <li>{@link org.occiware.occi.platform.impl.ComponentImpl#getOcciComponentStateMessage <em>Occi Component State Message</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentImpl extends ResourceImpl implements Component {
	...
	public void configure() {
		throw new UnsupportedOperationException();  // FIXME Unimplemented http://schemas.modmacao.org/occi/platform/ecore!Component!configure()
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case PlatformPackage.COMPONENT___STOP:
				stop();
				return null;
			case PlatformPackage.COMPONENT___CONFIGURE:
				configure();
				return null;
			case PlatformPackage.COMPONENT___DEPLOY:
				deploy();
				return null;
			case PlatformPackage.COMPONENT___UNDEPLOY:
				undeploy();
				return null;
		}
