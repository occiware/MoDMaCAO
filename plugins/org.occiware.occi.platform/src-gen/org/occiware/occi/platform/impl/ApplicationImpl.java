 ...
 * </p>
 * <ul>
 *   <li>{@link org.occiware.occi.platform.impl.ApplicationImpl#getOcciAppName <em>Occi App Name</em>}</li>
 *   <li>{@link org.occiware.occi.platform.impl.ApplicationImpl#getOcciAppContext <em>Occi App Context</em>}</li>
 *   <li>{@link org.occiware.occi.platform.impl.ApplicationImpl#getOcciAppUrl <em>Occi App Url</em>}</li>
 *   <li>{@link org.occiware.occi.platform.impl.ApplicationImpl#getOcciAppState <em>Occi App State</em>}</li>
 *   <li>{@link org.occiware.occi.platform.impl.ApplicationImpl#getOcciAppStateMessage <em>Occi App State Message</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ApplicationImpl extends ResourceImpl implements Application {
	...
	public void configure() {
		throw new UnsupportedOperationException();  // FIXME Unimplemented http://schemas.modmacao.org/occi/platform/ecore!Application!configure()
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case PlatformPackage.APPLICATION___STOP:
				stop();
				return null;
			case PlatformPackage.APPLICATION___CONFIGURE:
				configure();
				return null;
			case PlatformPackage.APPLICATION___DEPLOY:
				deploy();
				return null;
			case PlatformPackage.APPLICATION___UNDEPLOY:
				undeploy();
				return null;
		}
