...
public class Res_tplImpl extends MixinBaseImpl implements Res_tpl {
	...
	public boolean appliesConstraint(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		if (le) {
			...
			final /*@NonInvalid*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, entity_0, TYP_platform_c_c_Component_0).booleanValue();
			...
			if (oclIsKindOf) {
				...
				final /*@NonInvalid*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, entity_0, TYP_platform_c_c_Application_0).booleanValue();
