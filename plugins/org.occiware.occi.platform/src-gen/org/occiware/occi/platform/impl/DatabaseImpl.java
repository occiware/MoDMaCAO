 ...
 * </p>
 * <ul>
 *   <li>{@link org.occiware.occi.platform.impl.DatabaseImpl#getOcciDatabaseVersion <em>Occi Database Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DatabaseImpl extends MixinBaseImpl implements Database {
	...
	public boolean appliesConstraint(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, PlatformTables.STR_Database_c_c_appliesConstraint);
		...
		if (le) {
			...
			final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_platform_c_c_Component_0 = idResolver.getClass(PlatformTables.CLSSid_Component, null);
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, PlatformTables.STR_Database_c_c_appliesConstraint, this, (Object)null, diagnostics, context, (Object)null, severity_0, result, PlatformTables.INT_0).booleanValue();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case PlatformPackage.DATABASE___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP:
