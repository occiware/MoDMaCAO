 ...
 * from:
 *   /org.occiware.occi.platform/model/platform.ecore
 * using:
 *   /org.occiware.occi.platform/model/platform.genmodel
...
import org.occiware.occi.platform.PlatformTables;
...
public class PlatformTables
{
	...
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.NsURIPackageId PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore = org.eclipse.ocl.pivot.ids.IdManager.getNsURIPackageId("http://schemas.modmacao.org/occi/platform/ecore", null, org.occiware.occi.platform.PlatformPackage.eINSTANCE);
	...
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_App_tpl = org.occiware.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore.getClassId("App_tpl", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Application = org.occiware.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore.getClassId("Application", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Class = org.occiware.occi.platform.PlatformTables.PACKid_$metamodel$.getClassId("Class", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Component = org.occiware.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore.getClassId("Component", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Componentlink = org.occiware.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore.getClassId("Componentlink", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Database = org.occiware.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore.getClassId("Database", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Databaselink = org.occiware.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore.getClassId("Databaselink", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Entity = org.occiware.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_ogf_org_s_occi_s_core_s_ecore.getClassId("Entity", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Res_tpl = org.occiware.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore.getClassId("Res_tpl", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Resource = org.occiware.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_ogf_org_s_occi_s_core_s_ecore.getClassId("Resource", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.DataTypeId DATAid_URI = org.occiware.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore.getDataTypeId("URI", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.DataTypeId DATAid_URL = org.occiware.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore.getDataTypeId("URL", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.EnumerationId ENUMid_Status = org.occiware.occi.platform.PlatformTables.PACKid_http_c_s_s_schemas_modmacao_org_s_occi_s_platform_s_ecore.getEnumerationId("Status");
	...
	public static class EnumerationLiterals {
		...
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _Status__undeployed = new EcoreExecutorEnumerationLiteral(PlatformPackage.Literals.STATUS.getEEnumLiteral("undeployed"), Types._Status, 3);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _Status__deployed = new EcoreExecutorEnumerationLiteral(PlatformPackage.Literals.STATUS.getEEnumLiteral("deployed"), Types._Status, 4);
