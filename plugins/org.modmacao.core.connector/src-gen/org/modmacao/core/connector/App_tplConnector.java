...
public class App_tplConnector extends org.modmacao.occi.platform.impl.App_tplImpl
{
	 ...
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(App_tplConnector.class);

	// Start of user code App_tplconnector_constructor
	/**
	 * Constructs a app_tpl connector.
	 */
	App_tplConnector()
	{
